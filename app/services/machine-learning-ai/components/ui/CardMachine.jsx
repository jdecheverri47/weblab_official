...
function CardMachine({ image, title, description, subtitle}) {
  return (
    <Card className="col-span-12 sm:col-span-4 h-[300px] w-[500px] group/machine hover:scale-105 hover:shadow-2xl transition-all !duration-400 ease-[cubic-bezier(.25,.75,.5,1.25)]">
      <CardHeader className="absolute z-10 top-0 flex-col !items-start bg-gradient-to-b from-gray-950 to-transparent h-[25%] transition-all !duration-400 ease-[cubic-bezier(.25,.75,.5,1.25)] group-hover/machine:h-full overflow-hidden group-hover/machine:to-indigo-950 group-hover/machine:cursor-pointer ">
